<%@ Control Language="C#" AutoEventWireup="true" Inherits="DotNetNuke.Modules.Reports.Visualizers.Xslt.Settings" Codebehind="Settings.ascx.cs" %>
...
<dnn:Url ID="ctlTransform" runat="server" Width="400px" ShowUrls="True" ShowTabs="False"
         ShowLog="False" ShowTrack="False" Required="True" FileFilter="xsl,xslt">
</dnn:Url>
...
<asp:MultiView ID="mvExtensionObjects" runat="server">
    ...
    <asp:View ID="vwAllowed" runat="server">
        ...
        <asp:GridView ID="grdExtensionObjects" runat="server"
                      AutoGenerateColumns="False" OnRowDeleting="grdExtensionObjects_RowDeleting">
            <Columns>
        ...
        <asp:LinkButton ID="btnAddExtensionObject" runat="server" ResourceKey="btnAddExtensionObject" OnClick="btnAddExtensionObject_Click"/>
    </asp:View>
</asp:MultiView>